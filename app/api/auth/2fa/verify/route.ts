...
import { enable2FA, getAuthUserById } from "@/lib/auth/userService";
...
export async function POST(req: NextRequest) {
    try {
        ...
        // Refresh token to include twoFactorEnabled: true
        ...
        return NextResponse.json({ success: true, message: "Đã bật bảo mật 2 lớp thành công" });
    } catch (err: any) {
        console.error("/api/auth/2fa/verify error:", err);
