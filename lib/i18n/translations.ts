export const translations = {
  en: {
    ...
    home: {
      ...
      features: {
        ...
        shrineDesc: "Light candles and receive blessings from the HIGH PRIEST. A fun interactive minigame!",
        enterShrine: "Enter CHURCH",
        predictionTitle: "PREDICTION GAME",
        predictionDesc: "Predict scores, MVP, First Blood... Correct predictions earn Gen.G Points!",
        joinNow: "Join Now",
        minigame: "MINIGAME",
      },
    },
    ...
    // Team page
    team: {
      badge: "2025-2026 ROSTER",
      title: "CURRENT ROSTER",
      subtitle: "Five superstars. One goal. Bringing glory to Gen.G in LCK and internationally.",
      franchisePlayer: "FRANCHISE PLAYER",
      viewProfile: "View Profile",
      viewAlumni: "View Former Players",
      ...
      achievements: {
        title: "2025 ACHIEVEMENTS",
        subtitle: "Season Performance & Titles",
        winRate: "Win Rate",
        champion: "CHAMPION",
        runnerUp: "Runner-up",
    ...
    shrine: {
      ...
      title: "CHURCH OF CHOVY",
      highPriest: "HIGH PRIEST",
      realName: "Jeong Ji-hoon • 정지훈",
      role: "MID LANER",
      lightCandleTitle: "LIGHT CANDLES FOR BLESSING",
      lightCandleDesc: "Light candles before matches to send your wishes to Chovy",
      lightCandle: "Light a Candle",
      allCandlesLit: "All Candles Lit!",
      candlesLit: "Candles Lit",
      candlesCount: "/ 10",
      blessingTitle: "HIGH PRIEST HAS BLESSED YOU!",
      blessingMessage: "Chovy has received your prayers",
      blessingWish: "Good luck will come to the team in the next match!",
      
      // Stats
      legendaryStats: "LEGENDARY STATS",
      kda: "KDA",
      csPerMin: "CS/Min",
      ...
      signatureChampions: "SIGNATURE CHAMPIONS",
      
      // Quotes
      chosenQuote: "THE CHOSEN ONE",
    },
    ...
    about: {
      title: "ABOUT",
      subtitle: "Gen.G Fandom Website",
      aiProduct: "This is an AI-powered product",
      editedBy: "Content edited by a Gen.G fan",
      contribute: "If you'd like to contribute to this website, please contact us",
      admin: "Admin",
    ...
    credits: {
      title: "CREDITS",
      subtitle: "Acknowledgments & Resources",
      ...
      aiToolsList: [
        { name: "Claude & Cursor", description: "Code by Claude and Cursor" },
      ],
      dataSourcesList: [
        { name: "LoL Esports Wiki", url: "https://lol.fandom.com", description: "Player data and statistics" },
        { name: "Gen.G Official", url: "https://geng.gg", description: "Official team information" },
        { name: "LoL Esports", url: "https://lolesports.com", description: "Tournament data and results" },
      ],
      imageSourcesList: [
        { name: "LoL Esports Wiki", description: "Player photos" },
        { name: "LoL Esports Official", description: "Team and tournament logos" },
        { name: "Gen.G Official", description: "Official branding assets" },
      ],
      thanks: [
        "Gen.G Esports for inspiring this fan project",
        "The Gen.G community for their passion and support",
  ...
  vi: {
    ...
    home: {
      ...
      features: {
        shrineTitle: "CHURCH OF CHOVY",
        shrineDesc: "Thắp nến và nhận lời chúc phúc từ giáo chủ 'Vinh dọn lúa'. Trò chơi tương tác thú vị!",
        enterShrine: "Vào Đền Thờ",
        predictionTitle: "GAME DỰ ĐOÁN",
        predictionDesc: "Dự đoán tỉ số, MVP, First Blood... Đúng sẽ nhận điểm Gen.G Points!",
    ...
    // Team page
    team: {
      badge: "ĐỘI HÌNH 2025-2026",
      title: "ĐỘI HÌNH HIỆN TẠI",
      subtitle: "Gặp gỡ GOAT Duro và 4 'cân lương'.",
      franchisePlayer: "TUYỂN THỦ TRỤ CỘT",
      goatLabel: "GOAT",
      viewProfile: "Xem Hồ Sơ",
      viewAlumni: "Xem Cựu Tuyển Thủ",
      viewLegends: "Điện Vinh Danh",
    ...
    shrine: {
      ...
      highPriest: "GIÁO CHỦ",
      realName: "Jeong Ji-hoon • 정지훈",
      role: "TUYỂN THỦ ĐƯỜNG GIỮA",
      lightCandleTitle: "THẮP NẾN CẦU MAY",
      lightCandleDesc: "Thắp nến trước trận đấu để gửi lời chúc may mắn đến Chovy",
      lightCandle: "Thắp nến",
      allCandlesLit: "Tất cả nến đã được thắp!",
      candlesLit: "Nến đã thắp",
      candlesCount: "/ 10",
      blessingTitle: "GIÁO CHỦ ĐÃ ĐƯỢC CHÚC PHÚC!",
      blessingMessage: "Chovy đã nhận được lời cầu nguyện của bạn",
      blessingWish: "May mắn sẽ đến với đội trong trận đấu tiếp theo!",
      
      // Stats
      legendaryStats: "CHỈ SỐ HUYỀN THOẠI",
      kda: "KDA",
      csPerMin: "CS/Phút",
      killParticipation: "Tham Gia Hạ Gục",
      visionScore: "Điểm Tầm Nhìn",
      goldPerMin: "Vàng/Phút",
      damageShare: "Tỉ Lệ Sát Thương",
      
      // Hall of Fame
      hallOfFame: "ĐIỆN VINH DANH",
      signatureChampions: "TƯỚNG ĐẶC TRƯNG",
    ...
    about: {
      title: "GIỚI THIỆU",
      subtitle: "Website Gen.G Fandom",
      aiProduct: "Đây là website được mình vibe code bằng AI :)), còn nhiều sai sót rất mong các bạn thông cảm",
      editedBy: "Được biên tập nội dung bởi mình, và code bởi AI",
      contribute: "Nếu các bạn có nhu cầu đóng góp thêm website thì hãy liên hệ mình qua thông tin bên dưới. Hoặc có thể đóng góp thông qua Github.",
      admin: "Admin",
    ...
    credits: {
      ...
      technologies: [
        { name: "Next.js 14", description: "Framework React với App Router" },
        { name: "TypeScript", description: "JavaScript an toàn kiểu dữ liệu" },
        { name: "Tailwind CSS", description: "Framework CSS utility-first" },
        { name: "Framer Motion", description: "Thư viện animation" },
        { name: "Lucide React", description: "Thư viện icon" },
      ],
      aiToolsList: [
        { name: "Claude & Cursor", description: "Code bằng Claude và Cursor" },
      ],
      dataSourcesList: [
        { name: "LoL Esports Wiki", url: "https://lol.fandom.com", description: "Dữ liệu tuyển thủ và thống kê" },
        { name: "Gen.G Official", url: "https://geng.gg", description: "Thông tin chính thức của đội" },
        { name: "LoL Esports", url: "https://lolesports.com", description: "Dữ liệu giải đấu và kết quả" },
      ],
      imageSourcesList: [
        { name: "LoL Esports Wiki", description: "Ảnh tuyển thủ" },
        { name: "LoL Esports Official", description: "Logo đội và giải đấu" },
        { name: "Gen.G Official", description: "Tài sản thương hiệu chính thức" },
      ],
      thanks: [
        "Gen.G Esports đã truyền cảm hứng cho dự án fan này",
